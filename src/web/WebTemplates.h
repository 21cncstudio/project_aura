            ...
            <form method="POST" action="/save" id="wifi-form">
                ...
                <div class="pass-section" id="personal-pass-section">
                    ...
                    <div class="input-wrapper">
                        <input type="password" name="pass" id="pass" placeholder="Enter password" autocomplete="current-password" minlength="8" maxlength="63" title="Leave blank for an open network, or enter an 8-63 byte password">
