...
private:
    ...
    void apply_contextual_date_format_default(Config::Language previous_language,
                                              bool previous_units_c);
    ...
    float pressure_delta_to_msl_hpa(float pressure_delta_hpa) const;
    float pressure_hpa_to_display_units(float pressure_hpa) const;
    ...
    void update_pressure_altitude_preview();
    void style_accent_button(lv_obj_t *btn, lv_obj_t *label, lv_color_t accent);
    void nudge_pressure_altitude(int delta_m);
    void apply_pressure_altitude_setting();
    ...
    void on_set_altitude_event(lv_event_t *e);
    void on_altitude_plus_100_event(lv_event_t *e);
    void on_altitude_plus_10_event(lv_event_t *e);
    void on_altitude_plus_1_event(lv_event_t *e);
    void on_altitude_minus_1_event(lv_event_t *e);
    void on_altitude_minus_10_event(lv_event_t *e);
    void on_altitude_minus_100_event(lv_event_t *e);
    void on_altitude_apply_event(lv_event_t *e);
    ...
    static void on_set_altitude_event_cb(lv_event_t *e);
    static void on_altitude_plus_100_event_cb(lv_event_t *e);
    static void on_altitude_plus_10_event_cb(lv_event_t *e);
    static void on_altitude_plus_1_event_cb(lv_event_t *e);
    static void on_altitude_minus_1_event_cb(lv_event_t *e);
    static void on_altitude_minus_10_event_cb(lv_event_t *e);
    static void on_altitude_minus_100_event_cb(lv_event_t *e);
    static void on_altitude_apply_event_cb(lv_event_t *e);
