 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --no-compress --font ..\..\Downloads\Montserrat\static\Montserrat-Medium.ttf --symbols 0123456789 --format lvgl
 ******************************************************************************/
...
#ifndef UI_FONT_MONTSERRAT_MEDIUM_96_DIGITS
#define UI_FONT_MONTSERRAT_MEDIUM_96_DIGITS 1
#endif

#if UI_FONT_MONTSERRAT_MEDIUM_96_DIGITS
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_montserrat_medium_96_digits = {
#else
lv_font_t ui_font_montserrat_medium_96_digits = {
#endif
...
#endif /*#if UI_FONT_MONTSERRAT_MEDIUM_96_DIGITS*/
