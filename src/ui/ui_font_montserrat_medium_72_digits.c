 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --bpp 4 --size 72 --no-compress --font ..\..\Downloads\Montserrat\static\Montserrat-Medium.ttf --symbols 01234567890- --format lvgl
 ******************************************************************************/
...
#ifndef UI_FONT_MONTSERRAT_MEDIUM_72_DIGITS
#define UI_FONT_MONTSERRAT_MEDIUM_72_DIGITS 1
#endif

#if UI_FONT_MONTSERRAT_MEDIUM_72_DIGITS
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_montserrat_medium_72_digits = {
#else
lv_font_t ui_font_montserrat_medium_72_digits = {
#endif
...
#endif /*#if UI_FONT_MONTSERRAT_MEDIUM_72_DIGITS*/
