...
void UiController::on_fw_update_allow_event_cb(lv_event_t *e) { if (instance_) instance_->on_fw_update_allow_event(e); }
void UiController::on_fw_update_deny_event_cb(lv_event_t *e) { if (instance_) instance_->on_fw_update_deny_event(e); }
...
void UiController::on_language_event(lv_event_t *e) {
    ...
    const Config::Language previous_language = ui_language;
    const bool previous_units_c = temp_units_c;
    UiLocalization::cycleLanguage(*this);
    apply_contextual_date_format_default(previous_language, previous_units_c);
    update_ui();
    update_wifi_ui();
    update_mqtt_ui();
    update_datetime_ui();
