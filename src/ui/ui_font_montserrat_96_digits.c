 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --no-compress --font ..\..\Downloads\Montserrat\static\Montserrat-Regular.ttf --symbols 0123456789 --format lvgl
 ******************************************************************************/
...
#ifndef UI_FONT_MONTSERRAT_96_DIGITS
#define UI_FONT_MONTSERRAT_96_DIGITS 1
#endif

#if UI_FONT_MONTSERRAT_96_DIGITS
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1017, .box_w = 55, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 1898, .adv_w = 554, .box_w = 24, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2702, .adv_w = 872, .box_w = 50, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4402, .adv_w = 866, .box_w = 50, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6102, .adv_w = 1015, .box_w = 60, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 8112, .adv_w = 869, .box_w = 49, .box_h = 68, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 9778, .adv_w = 935, .box_w = 52, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 11572, .adv_w = 905, .box_w = 50, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 13247, .adv_w = 980, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 15076, .adv_w = 935, .box_w = 52, .box_h = 69, .ofs_x = 2, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_montserrat_96_digits = {
#else
lv_font_t ui_font_montserrat_96_digits = {
#endif
...
#endif /*#if UI_FONT_MONTSERRAT_96_DIGITS*/
