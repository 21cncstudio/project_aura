...
void UiEventBinder::bindAvailableEvents(UiController &owner, int screen_id) {
    ...
    const EventBinding click_bindings[] = {
        ...
        {objects.btn_set_altitude, UiController::on_set_altitude_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_plus_100, UiController::on_altitude_plus_100_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_plus_10, UiController::on_altitude_plus_10_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_plus_1, UiController::on_altitude_plus_1_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_minus_1, UiController::on_altitude_minus_1_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_minus_10, UiController::on_altitude_minus_10_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_minus_100, UiController::on_altitude_minus_100_event_cb, LV_EVENT_CLICKED},
        {objects.btn_altitude_apply, UiController::on_altitude_apply_event_cb, LV_EVENT_CLICKED},
