...
void test_first_poweron_failure_requests_one_restart() {
...
void test_other_reset_reason_does_not_auto_restart() {
    TEST_ASSERT_EQUAL_INT(static_cast<int>(Decision::SuppressResetReason),
...
int main(int, char **) {
    ...
    RUN_TEST(test_first_poweron_failure_requests_one_restart);
    RUN_TEST(test_recovery_boot_failure_stays_headless);
    RUN_TEST(test_other_reset_reason_does_not_auto_restart);
