...
- `WR_IO` comes from the C-compatible `include/Ch422gBoardPolicy.h`: `0xDF`
...
- The 4.3-inch image changes only EXIO5 relative to upstream `0xFF`; it does
  not inherit the 7-inch LCD/touch/backlight startup levels.
...
WR_IO  address=0x38 data=0xDF (4.3-inch) or 0xD1 (7-inch)
